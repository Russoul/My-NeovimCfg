...
-- Self-explanatory
vim.cmd[[Plug 'https://github.com/JamshedVesuna/vim-markdown-preview.git']]
...
vim.cmd[[Plug 'ShinKage/idris2-nvim']]
...
vim.cmd[[Plug 'https://github.com/matze/vim-move']]
...
g.vim_markdown_preview_pandoc = 1
g.vim_markdown_preview_toggle = 0
g.vim_markdown_preview_hotkey = '<C-x>ma'
...
vim.api.nvim_create_autocmd("BufNewFile,BufRead", {
    pattern = "*.hott",
    callback = function(args) vim.bo.filetype = "hott" end,
